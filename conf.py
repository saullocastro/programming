...
project = 'Programming'
copyright = 'since 2012 Saullo G. P. Castro'
...
#latex_documents = [('index', 'sympy-%s.tex' % release,
#                   'SymPy Documentation',
...
#texinfo_documents = [
    #(master_doc, 'programming', 'Programming Documentation',
                 #'Compmech Development Team',
   #'Programming', 'Computational Mechanics in Python', 'Programming', 1),
#]
